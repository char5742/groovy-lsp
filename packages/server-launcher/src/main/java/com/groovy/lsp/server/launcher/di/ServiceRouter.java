...
public class ServiceRouter {
    ...
    public ServiceRouter(
        ...
        this.compilerConfigurationService = Objects.requireNonNull(compilerConfigurationService, 
            "CompilerConfigurationService must not be null");
        this.typeInferenceService = Objects.requireNonNull(typeInferenceService, 
            "TypeInferenceService must not be null");
        this.workspaceIndexService = Objects.requireNonNull(workspaceIndexService, 
            "WorkspaceIndexService must not be null");
        this.formattingService = Objects.requireNonNull(formattingService, 
            "FormattingService must not be null");
    ...
    private void validateServices() {
        try {
            ...
            throw new IllegalStateException("Failed to initialize ServiceRouter: " + e.getMessage(), e);
        }
    }
