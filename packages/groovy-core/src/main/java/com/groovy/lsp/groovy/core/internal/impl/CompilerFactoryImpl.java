...
public class CompilerFactoryImpl implements CompilerConfigurationService {
    ...
    public static CompilerConfiguration createConfigurationWithClasspathStatic(
    ...
    public static CompilerConfiguration createTypeCheckingConfigurationStatic(
    ...
    private static ImportCustomizer createImportCustomizer() {
        ...
        // Add common imports
        imports.addImports("java.util.List", "java.util.Map", "java.util.Set");

        // Add star imports for commonly used packages
        imports.addStarImports("java.util", "java.io", "java.nio.file");

        // Add static imports
        imports.addStaticStars("java.util.Collections");
