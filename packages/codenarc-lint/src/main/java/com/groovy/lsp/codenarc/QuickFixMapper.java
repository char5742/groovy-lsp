...
public class QuickFixMapper {
    ...
    public List<CodeAction> getQuickFixesForViolation(
            Violation violation, @Nullable String filePath) {
    ...
    private Range createRangeForLine(int lineNumber) {
        return new Range(new Position(lineNumber, 0), new Position(lineNumber + 1, 0));
    }
