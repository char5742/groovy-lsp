...
public class WorkspaceIndexedEvent extends DomainEvent {
     ...
     */
    public WorkspaceIndexedEvent(
            Path workspacePath, int totalFiles, int totalSymbols, long indexingDurationMs) {
    ...
    public String toString() {
        return String.format(
                "WorkspaceIndexedEvent{workspacePath=%s, files=%d, symbols=%d, duration=%dms}",
